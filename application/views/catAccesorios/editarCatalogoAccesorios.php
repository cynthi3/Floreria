...
<form id="form" name="form" action="<?=base_url()?>controladorFloresYAccesorios/editarUnAccesorioAdmin" method="POST">
...
<div class="row">
   <div class="three sixth padded">
    ...
    <div align="center">
      ...
      <button type="submit" class="error" id="cancelar" name="cancelar">Cancelar</button>
    </div>
  </div>
